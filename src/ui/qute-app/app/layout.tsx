        ...
        <div className="navbar-fixed">
          <nav>
            <div className="nav-wrapper">
              <Link href={HREF_TASKS} className="brand-logo center">TODO-App</Link>
              <ul id="nav-mobile" className="left hide-on-med-and-down">
                <li className="active"><Link href={HREF_TASKS}><i
                    className="material-icons left">event_note</i>Aufgaben</Link></li>
